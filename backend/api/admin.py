...
from api.models import Certificate, CompletedLesson, Teacher, Category, Course, Variant, VariantItem, Cart, CartOrder, CartOrderItem, EnrolledCourse, Review, Notification, Coupon, Wishlist, Country, Question_Answer, Question_Answer_Message, Note, QuizOption, QuizQuestion
