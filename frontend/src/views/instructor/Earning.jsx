...
import { SERVER_URL, teacherId } from "../../utils/constants";

function Earning() {
  const [stats, setStats] = useState([]);
  const [earning, setEarning] = useState([]);
  const [bestSellingCourse, setBestSellingCourse] = useState([]);
  const [fetchingEarning, setFetchingEarning] = useState(true);
